...
all: libAdafruitStepperMotorHAT.a libAdafruitDCMotorHAT.a StepperMotorTest DCMotorTest StepperMotorSajat
...
StepperMotorSajat: libAdafruitStepperMotorHAT.a
	$(LD) $(LDFLAGS) -o StepperMotorSajat StepperMotorSajat.cpp libAdafruitStepperMotorHAT.a
