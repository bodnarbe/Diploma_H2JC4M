...
\def\keywords{mechatronics, controltechnology, Universal Robot, robotics, Direct kinematics, Surulical robotics controll}
...
%Kommenteld ki, ha használni szeretnéd. [Uncomment to use]
...
%Importáld a saját fejezeteidet [Import your own content]
\include{chapters/introduction}      % Bevezetés
\include{chapters/elvarasok}		 % 1. fejezet
\include{chapters/Gravitacio} 		 % 2. fejezet
\include{chapters/Ujratervezes}      % 3. fejezet
\include{chapters/Elektronika}       % 4. fejezet
\include{chapters/Program}			 % 5. fejezet
\include{chapters/koltseg}			 % 6. fejezet
