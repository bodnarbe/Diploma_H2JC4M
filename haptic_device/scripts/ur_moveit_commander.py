...
class Forward_kinematics:
    ...
    def forward_kinematics(self,joint_angles, r_TCP):
        ...
        t67 = self.dh_transform(t_6_7)
        t78 = self.dh_transform(t_7_8)
        t89 = self.dh_transform(t_8_9)
        ...
        t_07 = np.dot(t_06, t67)
        t_08 = np.dot(t_07, t78)
        t_09 = np.dot(t_08, t89)
        ...
        r_07 = np.dot(t_06, t67)
        r_08 = np.dot(t_07, t78)
        r_09 = np.dot(t_08, t89)
 
        r_TCP_num = np.array([[r_TCP[0]], [r_TCP[1]], [r_TCP[2]], [1]])
        t_0_TCP = np.round(np.dot(t_09, r_TCP_num), 4)
 
        R_09 = np.array([[t_09[0][0], t_09[0][1], t_09[0][2]],
                          [t_09[1][0], t_09[1][1], t_09[1][2]],
                          [t_09[2][0], t_09[2][1], t_09[2][2]]])
...
class MoveitCommander:
    def __init__(self, shift_x, shift_y, shift_z):
        self.moveit_commander = MoveGroupPythonInteface()
    ...
    def callback(self, msg):
        ...
        print("x:",pos_TCP[0] + self.shift_x,"y:", pos_TCP[1] + self.shift_y, "z:",pos_TCP[2] + self.shift_z)
